...
$(MAIN):
	...
	gcc -c pci_admin.c -ffreestanding -m32 -o pci_admin.o -std=gnu99

	gcc -c io.c -ffreestanding -m32 -o io.o -std=gnu99

	gcc -ffreestanding -m32 -nostdlib -o '$(MULTIBOOT)' -T linker.ld boot.o kernel.o hardware_specs.o io.o pci_admin.o stdio.o -lgcc -lc
